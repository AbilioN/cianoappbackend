...
<head>
    ...
    <title>Ciano - Recuperación de Contraseña</title>
...
<body>
    ...
    <div class="w-full min-h-[100vh] flex align-items-center justify-center">
        <div class="w-96 py-7 my-auto mx-auto text-[#0693e3] bg-cyan-200 border border-gray shadow-md rounded-md flex flex-col text-center justify-content-center">
            ...
            <h2 class="text-lg mt-6">Recuperación de Contraseña</h2>
            <form action="{{ route('password.update') }}" method="POST" class="mx-auto">
                ...
                <div class="mt-5">
                    <small class="block text-start pl-1">confirmar contraseña:</small>
            ...
            <span class="text-wrap text-xs max-w-full mt-7">© 2025 CIANO. Todos los derechos reservados.</span>
        </div>
    </div>
</body>
</html> 