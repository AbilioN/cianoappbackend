...
<head>
    ...
    <title>Ciano - Recupero Password</title>
...
<body>
    ...
    <div class="w-full min-h-[100vh] flex align-items-center justify-center">
        <div class="w-96 py-7 my-auto mx-auto text-[#0693e3] border border-gray shadow-md rounded-md flex flex-col text-center justify-content-center">
            ...
            <h2 class="text-lg mt-6">Reimposta Password</h2>
            <form action="{{ route('auth.password.update') }}" method="POST" class="mx-auto">
                ...
                <div class="mt-5">
                    <small class="block text-start pl-1">password:</small>
                ...
                <div class="mt-5">
                    <small class="block text-start pl-1">conferma password:</small>
                    <input type="password" required name="password_confirmation" class="rounded-[4px] w-full shadow-sm border border-gray-300 ">
                </div>

                <button type="submit" class="bg-gray-200 rounded-2xl mt-5 px-5 py-1 border border-gray-500 shadow-md">conferma</button>
            ...
            <span class="text-wrap text-xs max-w-full mt-7">© 2025 CIANO. Tutti i diritti riservati.</span>
        </div>
    </div>
